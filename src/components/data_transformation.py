...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            num_pipeline = Pipeline(
                steps=[
                    ("imputer", SimpleImputer(strategy="median")),  ## to eleminate missing values
            ...
            logging.info("Numerical columns standard scailing completed")
            logging.info("Catrgorical columns encoding completed")
    ...
    def initiata_data_transformation(self, train_path, test_path):
        ...
        try:
            ...
            logging.info("obtaining pre processing onject")
            ...
            logging.info(
                f"Applying prepprocessing objects on training and testing dataframe"
            )
